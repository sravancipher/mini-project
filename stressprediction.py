...
def app():    
    ...
    form=st.form("form1")
    sr=form.number_input("Snoring Rate",key="1",min_value=40, max_value=100)
    form.write("Value should be between 40 and 100")
    rr=form.number_input("Respiration Rate",key="2",min_value=16, max_value=30)
    form.write("Value should be between 16 and 30")
    bt=form.number_input("Body Temperature",key="3",min_value=80, max_value=99)
    form.write("Value should be between 80 and 99")
    lm=form.number_input("Limb Movement",key="4",min_value=4, max_value=25)
    form.write("Value should be between 4 and 25")
    bo=form.number_input("Blood Oxygen",key="6",min_value=80, max_value=97)
    form.write("Value should be between 80 and 97")
    em=form.number_input("Eye Movement",key="7",min_value=60, max_value=110)
    form.write("Value should be between 60 and 110")
    sh=form.number_input("Sleeping Hours",key="8",min_value=0, max_value=9)
    form.write("Value should be between 0 and 9")
    hr=form.number_input("Heart Rate",key="9",min_value=50, max_value=100)
