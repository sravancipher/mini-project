...
import stressprediction,home,stresslevels,heartstatistics,about,contact
class Sidebar:
    def __init__(self):
        self.apps=[]
    ...
    def run():
        with st.sidebar:
            app=option_menu(
                ...
                options=["Home","Stress Levels","Heart Statistics","About","Contact"],
                default_index=0,
            )
        if(app=="Home"):
